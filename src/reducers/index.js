...
import improvementNotesReducer, { IMPROVEMENT_NOTES_DATA_NAME } from './improvementNotesReducer';
import userChampionListsReducer, { USER_CHAMPION_LIST_DATA_NAME } from './userChampionListsReducer';
...
export const toBeSavedData = [IMPROVEMENT_NOTES_DATA_NAME, USER_CHAMPION_LIST_DATA_NAME];
